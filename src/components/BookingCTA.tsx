        ...
        <div className="bg-white rounded-lg shadow-lg overflow-hidden">
          <div className="flex flex-col md:flex-row">
            <div className="md:w-1/2 bg-gradient-to-br from-blue-700 to-blue-800 p-8 text-white">
              ...
              {/* Prominent DIY services banner */}
              <div className="mt-6">
                <div className="relative overflow-hidden rounded-lg bg-gradient-to-r from-[#f0d541] to-[#e6cb3d] p-4 shadow-lg border-2 border-yellow-300">
                  ...
                  <div className="relative flex items-center space-x-3">
                    ...
                    <div className="flex-shrink-0">
                      <div className="w-10 h-10 bg-blue-800 rounded-full flex items-center justify-center shadow-md">
                        <svg className="w-6 h-6 text-[#f0d541]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="text-blue-800 text-sm font-medium">
                        Ask about our self-guided options!
                      </div>
                    </div>
                    {/* Arrow indicator */}
                    <div className="flex-shrink-0">
