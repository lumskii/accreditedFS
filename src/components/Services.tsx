      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow border-t-4 border-[#f0d541]">
            ...
            <p className="text-gray-600">Comprehensive review of your credit reports from all three major bureaus (Experian, Equifax, TransUnion) to identify errors, inaccuracies, and negative items affecting your credit score.</p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow border-t-4 border-[#f0d541]">
            <div className="text-blue-700 mb-4"><FileText size={40} /></div>
            <h3 className="text-xl font-semibold mb-2">Dispute Resolution</h3>
            <p className="text-gray-600">Professional handling of credit disputes for inaccurate, unverifiable, or outdated information on your reports, following federal credit laws and consumer protection regulations.</p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow border-t-4 border-[#f0d541]">
            <div className="text-blue-700 mb-4"><TrendingUp size={40} /></div>
            <h3 className="text-xl font-semibold mb-2">Score Improvement</h3>
            <p className="text-gray-600">Strategic planning and proven techniques to help you build positive credit history and improve your overall credit score for better loan rates and financial opportunities.</p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow border-t-4 border-[#f0d541]">
            <div className="text-blue-700 mb-4"><Shield size={40} /></div>
            <h3 className="text-xl font-semibold mb-2">Credit Education</h3>
            <p className="text-gray-600">Personalized guidance on maintaining good credit, understanding credit laws, and avoiding common credit pitfalls to protect your financial future.</p>
          </div>
        </div>
